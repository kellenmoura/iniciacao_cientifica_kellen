...
from gaphor.UML3 import uml3 as UML3
...
@format.register(UML3.Operation)
...
@format.register(UML3.Parameter)
...
@format.register(UML3.Slot)
def format_slot(el):
    return f'{el.definingFeature.name} = "{el.value}"'


@format.register(UML3.NamedElement)
