...
class HeritageItem(LinePresentation[UML3.Heritage], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: HeritageItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
