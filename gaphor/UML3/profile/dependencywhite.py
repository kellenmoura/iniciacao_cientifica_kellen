...
@represents(UML3.Dependencywhite)
class DependencywhiteItem(LinePresentation[UML3.Dependencywhite], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Dependencywhite",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: DependencywhiteItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> DependencywhiteItem:
