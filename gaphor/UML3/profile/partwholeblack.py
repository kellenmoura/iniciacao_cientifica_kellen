...
class PartwholeblackItem(LinePresentation[UML3.Partwholeblack], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: PartwholeblackItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> PartwholeblackItem:
