...
class MaterialConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        return True
'''@Connector.register(StereotypeRelator, MaterialItem)
class MaterialConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        ...
        if c1 and c2:
            ...
            ext: UML3.Material
            for ext in line.model.select(UML3.Material):  # type: ignore[assignment]
                ...
                relation = UML3.model.create_Material(head_type, tail_type)
