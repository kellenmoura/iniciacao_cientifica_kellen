...
@represents(UML3.Containment)
class ContainmentItem(LinePresentation[UML3.Containment], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Containment",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: ContainmentItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> ContainmentItem:
