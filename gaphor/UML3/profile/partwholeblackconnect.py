...
class PartwholeblackConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        return True
'''@Connector.register(StereotypeRelator, PartwholeblackItem)
class PartwholeblackConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        ...
        if c1 and c2:
            ...
            ext: UML3.Partwholeblack
            for ext in line.model.select(UML3.Partwholeblack):  # type: ignore[assignment]
                ...
                # Create a new Partwholeblack relationship
                relation = UML3.model.create_Partwholeblack(head_type, tail_type)
