...
class DependencyblackItem(LinePresentation[UML3.Dependencyblack], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: DependencyblackItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> DependencyblackItem:
