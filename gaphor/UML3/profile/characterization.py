...
class CharacterizationItem(LinePresentation[UML3.Characterization], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: CharacterizationItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> CharacterizationItem:
