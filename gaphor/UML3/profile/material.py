...
@represents(UML3.Material)
class MaterialItem(LinePresentation[UML3.Material], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Material",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: MaterialItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
