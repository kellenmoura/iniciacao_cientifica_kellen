...
class ComponentofItem(LinePresentation[UML3.Componentof], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: ComponentofItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> ComponentofItem:
