...
@represents(UML3.Mediation)
class MediationItem(LinePresentation[UML3.Mediation], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Mediation",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: MediationItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
