...
@represents(UML3.Structuration)
class StructurationItem(LinePresentation[UML3.Structuration], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Structuration",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: StructurationItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> StructurationItem:
