...
class SubquantityofItem(LinePresentation[UML3.Subquantityof], Named):
...
class AssociationEnd:
    ...
    def __init__(self, owner: SubquantityofItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> SubquantityofItem:
