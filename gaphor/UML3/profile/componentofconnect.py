...
class ComponentofConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        return True
'''@Connector.register(StereotypeRelator, ComponentofItem)
class ComponentofConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        ...
        if c1 and c2:
            ...
            ext: UML3.Componentof
            for ext in line.model.select(UML3.Componentof):  # type: ignore[assignment]
                ...
                # Create a new Componentof relationship
                relation = UML3.model.create_Componentof(head_type, tail_type)
