...
class MediationConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        return True
'''@Connector.register(StereotypeRelator, MediationItem)
class MediationConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        ...
        if c1 and c2:
            ...
            ext: UML3.Mediation
            for ext in line.model.select(UML3.Mediation):  # type: ignore[assignment]
                ...
                # Create a new Mediation relationship
                relation = UML3.model.create_Mediation(head_type, tail_type)
