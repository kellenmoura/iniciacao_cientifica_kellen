...
class PartwholeItem(LinePresentation[UML3.Partwhole], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Partwhole",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: PartwholeItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
