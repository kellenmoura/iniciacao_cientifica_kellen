...
@represents(UML3.Memberofblack)
class MemberofblackItem(LinePresentation[UML3.Memberofblack], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Memberofblack",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: MemberofblackItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
    ...
    @property
    def owner(self) -> MemberofblackItem:
