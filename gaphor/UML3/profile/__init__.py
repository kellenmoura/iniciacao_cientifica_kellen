'''from gaphor.UML3.profile import (
    ...
    materialconnect,
    mediationconnect,
    characterizationconnect,
    derivationconnect,
    structurationconnect,
    partwholeconnect,
    componentofconnect,
    containmentconnect,
    memberofconnect,
    subcollectionofconnect,
    subquantityofconnect,
    dependencyblackconnect,
    dependencywhiteconnect,
    partwholeblackconnect,
    memberofblackconnect,
    stereotypepropertypagesonto,
)'''
...
__all__ = ["HeritageItem"]
__all__ = ["FormalItem"]
__all__ = ["MaterialItem"]
__all__ = ["MediationItem"]
__all__ = ["CharacterizationItem"]
__all__ = ["DerivationItem"]
__all__ = ["StructurationItem"]
__all__ = ["PartwholeItem"]
__all__ = ["PartwholeblackItem"]
__all__ = ["ComponentofItem"]
__all__ = ["ContainmentItem"]
__all__ = ["DependencyblackItem"]
__all__ = ["DependencywhiteItem"]
__all__ = ["MemberofItem"]
__all__ = ["MemberofblackItem"]
__all__ = ["SubcollectionofItem"]
__all__ = ["SubquantityofItem"]
