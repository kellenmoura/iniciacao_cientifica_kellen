...
class PartwholeConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        return True
'''@Connector.register(StereotypeRelator, PartwholeItem)
class PartwholeConnect(RelationshipConnect):
    ...
    def connect_subject(self, handle):
        ...
        if c1 and c2:
            ...
            ext: UML3.Partwhole
            for ext in line.model.select(UML3.Partwhole):  # type: ignore[assignment]
                ...
                # Create a new Partwhole relationship
                relation = UML3.model.create_Partwhole(head_type, tail_type)
