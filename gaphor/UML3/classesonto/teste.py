...
@represents(UML3.Teste)
class TesteItem(LinePresentation[UML3.Teste], Named):
    ...
    def __init__(self, diagram, id=None):
        ...
        self.shape_middle = Box(
            Text(
                text=lambda: stereotypes_str(self.subject, ("Teste",)),
            ),
...
class AssociationEnd:
    ...
    def __init__(self, owner: TesteItem, end: Optional[str] = None):
        self._canvas = None
        self._owner = owner
        self._end = end
